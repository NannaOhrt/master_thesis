...
the two types of rate, a simple drawing below shows at which times the rates are determine. From the drawing
we see that all the spot rates are determine a time $t=0$, where the forward rate are determine at each time point.
\begin{center}
\begin{tikzpicture}
    % Draw the horizontal line with Time arrow
    \draw[-Latex] (2,0) -- (10.5,0) node[anchor=north] {Time};
    
    % Draw the curves for r1, r2, r3
...
\end{align*}
To end this section a drawing of the cashflow for a fixed coupon bond is illustrated below. 
\begin{center}
    \begin{tikzpicture}[font=\small] 
        % Draw the horizontal line
        \draw[-latex] (5,0) -- (13,0) node[anchor=north] {Time};
        ...
        \draw (5.75,-1.5) rectangle (6.25,-0.5) node[below, pos=.01] {Principal Payment};
        \draw (10.5,0) rectangle (10.25,1);
        \draw (8.5,0) rectangle (8.25,1);
        \draw (9.5,0) rectangle (9.25,1);
        \draw (7.5,0) rectangle (7.25,1);
        % Label the entire figure
...
\begin{center}
    \begin{tikzpicture}[font=\small] 
        ...
        \draw (5.75,-1.5) rectangle (6.25,-0.5) node[below, pos=.01] {Principal Payment};
        \draw (10.5,0) rectangle (10.25,1);
        \draw (8.5,0) rectangle (8.25,1.5);
        \draw (9.5,0) rectangle (9.25,1.2);
        \draw (7.5,0) rectangle (7.25,0.9);
        % Label the entire figure
        \node at (11.5, 2.5) {Principal Repayment};
        \node at (13.,1) {Principal Part};
        \node at (13.,1.75) {Interest Part};
...
\begin{center}
\begin{tikzpicture}
    % Define the styles for receivers and payers
