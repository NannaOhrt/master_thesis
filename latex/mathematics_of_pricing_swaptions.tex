...
The next question to be answered is what the "fair" price of these option, we will denote the price of
...
\end{theorem}
\noindent 
Then we have introduced Risk Neutral Valuation, hence there only thing left before we are able to price a 
...
\end{align*}
\begin{proposition}
    \textbf{(Black-Scholes Formula)} The price of a European call option with strike KK and time of maturity T 
