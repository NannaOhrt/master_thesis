...
more complex contract. So the idea is to get the fundamental understanding of pricing derivatives in a more simple case.
\\\\
...
be exercised at the maturity date, while American options can be exercised at any time up to the maturity date.
...
right to buy or sell. S denotes the market price of the underlying asset \cite{Bjork}. From \autoref{call_function} and \autoref{put_function} we see
...
\\\\
So now the contract function for the European call and put option has med introduced. The next question 
