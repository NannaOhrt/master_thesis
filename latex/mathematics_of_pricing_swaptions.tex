...
\begin{tikzpicture}[font=\small]
    ...
    % Add the box 
    \draw (11.75,1.5) rectangle (11.25,0.5) node[pos=.5, right=3mm] {Principal Part};
    \draw (11.75,2.) rectangle (11.25,1.5) node[pos=.5, right=3mm] {Interest Part};

    \draw (5.75,-1.5) rectangle (6.25,-0.5) node[below, pos=.01] {Principal Payment (K)};
    

    % Label the entire figure
    \node at (8,3) {Cash Flow Structure of a Zero Coupon Bond};
\end{tikzpicture}
\end{center}
