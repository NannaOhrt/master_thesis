...
So case we are look at is a European payer swaption. Further we will assume that there are m payments 
...
\begin{align}
    ...
    \label{swaptionspay}
\end{align}
Where we note that the cashflow generated from the payoff function of the swaption, is reviewed m times 
