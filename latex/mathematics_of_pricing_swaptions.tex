...
\\\\
The next question to be answered is what the "fair" price of these option. Again to simplify we will consider
...
\begin{proposition}
    ...
    \begin{align*}
        \Pi(t)_\text{call}  & =s N[d_1(t,s)] -e^{-r(T-t)}KN[d_2(t,s)]\\  
    \end{align*}
