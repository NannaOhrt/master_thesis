...
They by there construction the mechanism of "time value of money" is present. This instrument 
...
\begin{align*}
    F(t_1,t_2)= \frac{(1+p(t_0,t_2))^2}{(1+p(t_0,t_1))}-1
\end{align*}
...
\begin{definition}\label{def:forward}
    ...
    as \cite{Bjork} 
    \begin{align*}
        F(t;S,T)= - \frac{\log p(t,T)- \log p(t,S)}{(T-S)} 
    \end{align*}
\end{definition} 
