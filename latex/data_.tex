...
\item \textbf{Pay/Receive} \quad whether the holder pays or receives the fixed rate.
\end{itemize}
\noindent
...
This change implies a change in the parameter nu, since this parameter measure the volatility of volatility. 
