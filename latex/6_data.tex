...
market data on swaptions. In this thesis the data source is Citi Velocity, which is a market data platform
owned by Citi Bank.
\\\\
Before diving into the market data on swaptions, lets revisit the definition of a swaption. 
...
\end{itemize}
\noindent
As mentioned a 10Y10Y EUR swaption was analyzed, but lets clarify what a 10Y10Y EUR swaption entails. 
...
\\\\
Now a short introduction to swaption data has been covered, then the next step is to illustrate some 
...
we clearly see that the volatility surface is changing over the period. We see a pattern of the volatility surface moving 
...
this further in Section \ref{invest_sabr}.
\\
\begin{table}[H]
    \centering
    \scalebox{1}{
