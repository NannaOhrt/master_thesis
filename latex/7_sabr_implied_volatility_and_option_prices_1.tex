...
Black-Scholes model is the assumptions regarding the 
volatility, as mentioned earlier. In the Black-Scholes 
model the volatility is assumed to be constant and 
...
two Wiener processes, the asset price and its volatility. 
\\\\
...
To provide the intuition on how the dynamics listed in \autoref{f_dyn} and \autoref{sigma_dyn} behave, the dynamics is simulated ten times
for some chosen parameters is listed in \autoref{tab:parameters_sim_sabr}. 
The simulated paths are illustrated in \autoref{fig:sim_f_and_sigma} below. 
...
\begin{figure}[H]
    \centering
    \includegraphics[scale =0.5]{/Users/nannaingemannohrt/Desktop/master_thesis/main/plots/sim_f_and_sigma.png}
