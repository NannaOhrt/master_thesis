...
In this section a short view on how the process for the forward rate and the volatility develops over times will be covered. 
To provide the intuition on how the dynamic listed in \autoref{f_dyn} and \autoref{sigma_dyn} is simulated ten times 
for some chosen parameters. The simulated paths is illustrated in \autoref{fig:sim_f_and_sigma} below. 
From the \autoref{fig:sim_f_and_sigma} we that the dynamic are driven by the randomness in the Wiener process and 
it develops from the initial value of the forward rate and volatility.
\begin{figure}[htbp]
    \centering
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{/Users/nannaingemannohrt/Desktop/master_thesis/main/plots/SABR1_alpha.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{/Users/nannaingemannohrt/Desktop/master_thesis/main/plots/SABR_beta.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{/Users/nannaingemannohrt/Desktop/master_thesis/main/plots/SABR_nu.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{/Users/nannaingemannohrt/Desktop/master_thesis/main/plots/SABR_rho.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{/Users/nannaingemannohrt/Desktop/master_thesis/main/plots/SABR_f.png}
