...
In this section a short view on how the process for the forward rate and the volatility develops over times. 
To provide the intuition on how the dynamic listed in \autoref{f_dyn} and \autoref{sigma_dyn} is simulated ten times 
for some chosen parameters.
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{/Users/nannaingemannohrt/Desktop/master_thesis/main/plots/sim_f_and_sigma.png}
