...
yourself is, are volatility constant over a given time period?. In the next section another model will be introduced, 
where the volatility is not constant, but stochastic instead. 
