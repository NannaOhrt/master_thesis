...
The dynamic for the short rate in the Vasicek model is present below in \autoref{vas_dyn} and \autoref{vas_dyn_r0}
\begin{align}
...
tendency to revert towards the mean of the process.
\begin{figure}[h]
    \centering
